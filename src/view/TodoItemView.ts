...
export class TodoItemView {
     ...
     * @returns {Element}
     */
    createElement(todoItem: TodoItemModel, { onUpdateTodo, onDeleteTodo }: {onUpdateTodo: ({id, completed}: {id: number, completed: boolean}) => void, onDeleteTodo: ({id}: {id: number}) => void}) {
